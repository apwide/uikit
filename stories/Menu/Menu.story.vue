    ...
    <div>
        ...
        <BorderedPanel
            ...
            <template #actions>
                <KitActionMenu
                    title="Bla bla bla">
                    <KitMenuItem @click="select('add')">
                        Add entry
                    </KitMenuItem>
                    <KitMenuItem @click="select('edit')">
                        Edit entry
                    </KitMenuItem>
                    <KitMenuSeparator />
                    <KitMenuItem @click="select('delete')">
                        Delete entry
                    </KitMenuItem>
                </KitActionMenu>
            </template>
        ...
        <BorderedPanel
            ...
            <template #actions>
                <KitActionMenu
                    title="Bla bla bla">
                    <KitMenuItem v-if="false" @click="select('add')">
                        Add entry
                    </KitMenuItem>
                </KitActionMenu>
            </template>
