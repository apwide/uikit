...
input:checked + .kit-checkbox__icon ::v-deep rect {
  color: var(--kit-checkbox-checked-color);
  stroke: var(--kit-checkbox-checked-color);
}

input + .kit-checkbox__icon ::v-deep rect {
  color: var(--kit-checkbox-fill-color);
  stroke: var(--kit-checkbox-border-color);
}

label:hover input:not(:checked):not(:disabled) + .kit-checkbox__icon ::v-deep rect {
  fill: var(--kit-checkbox-hover-color);
}

label:hover input:not(:checked):not(:disabled) + .kit-checkbox__icon ::v-deep path {
  fill: var(--kit-checkbox-hover-color);
}

label:hover input:checked:not(:disabled) + .kit-checkbox__icon ::v-deep rect {
  color: var(--kit-checkbox-checked-hover-color);
  stroke: var(--kit-checkbox-checked-hover-color);
}

input + .kit-checkbox__icon ::v-deep path {
  fill: var(--kit-checkbox-checked-tick-color);
}

input:not([is-invalid]):focus + .kit-checkbox__icon ::v-deep rect {
  stroke: var(--kit-checkbox-focus-color);
}

input[is-invalid] + .kit-checkbox__icon ::v-deep rect {
  stroke: #ff5630;
}

input[disabled] + .kit-checkbox__icon ::v-deep rect {
  stroke: var(--kit-checkbox-disabled-border-color);
  color: var(--kit-checkbox-disabled-color);
}

input[disabled] + .kit-checkbox__icon ::v-deep path {
  fill: var(--kit-checkbox-disabled-border-color);
}

input:checked[disabled] + .kit-checkbox__icon ::v-deep path {
  fill: #a5adba;
}
...
:not(.kit-checkbox__indeterminate) ::v-deep rect {
