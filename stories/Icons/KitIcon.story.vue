<template>
    <div>
        ...
        <div class="grid-5">
            <div
                v-for="icon in solidSupportedIcons" :key="icon"
                class="box">
                <AwesomeIcon
        ...
        <div class="grid-5">
            <div
                v-for="icon in regularSupportedIcons" :key="icon"
                class="box">
                <AwesomeIcon
                    :title="icon" :type="icon" class="story-icon"
                    icon-style="regular"/>
                <span>{{ icon }}</span>
            </div>
        </div>
    ...
    export default {
        ...
        computed: {
            ...
            regularSupportedIcons() {
                return Object.keys(library.definitions.far);
            }
        },
        methods: {
            toggleColors() {
