<template>
    <div>
        <Button data-cy="show-modal" @click="showDialog([paragraphs[0]])">
            Show Dialog with little content
        </Button>
        <Button @click="showDialog(paragraphs)">
            Show Dialog with lots of content
        </Button>
        <ApwideModal
            v-if="show"
            auto-focus
