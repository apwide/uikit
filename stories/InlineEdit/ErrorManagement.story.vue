    ...
    export default {
        ...
        methods: {
            ...
            onGeneralError(value, callback) {
                ...
                error.generalError = 'Something went wrong, your request was refused by the big biss of the database. The issue is unrelated to the current edition, make sure to check you entries.';
                callback(error);
            }
        }
    };
