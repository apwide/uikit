...
.kit-time-picker-menu ::v-deep button[appearance='subtle']:not([disabled]):not([selected]):not([data-highlight]):hover {
  background-color: unset;
}
.kit-time-picker-menu ::v-deep button[data-highlight] {
  background-color: var(--kit-time-picker-selected-color);
  border-color: var(--kit-time-picker-selected-color);
}
</style>
