...
import SecureStringLineEditableRenderer from '@components/field-renderers/SecureStringLineEditableRenderer.vue'

describe('SecureStringLineEditableRenderer', () => {
  it('renders with required props', () => {
    const component = shallowMount(SecureStringLineEditableRenderer, { propsData: { value: 'secret123' } })
  ...
  it('renders a plain wrapper when editable is false', () => {
    const component = shallowMount(SecureStringLineEditableRenderer, {
