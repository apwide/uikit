...
button[loading] ::v-deep .kit-spinner {
  display: flex;
  position: absolute;
  left: 50%;
  top: 50%;
...
button[loading][selected] ::v-deep .kit-spinner {
  color: #fff;
}
...
button[appearance='default']:active ::v-deep svg {
  color: var(--kit-btn-default-active-text);
}
...
button[appearance='primary'][loading] ::v-deep .kit-spinner {
  color: var(--kit-btn-primary-text);
}
...
button[appearance='warning']:active ::v-deep svg,
button[appearance='warning'][selected] ::v-deep svg,
button[appearance='warning'][selected]:hover ::v-deep svg {
  color: var(--kit-btn-warn-active-text);
}
...
button[appearance='danger'][loading] ::v-deep .kit-spinner {
...
button[appearance='help'][loading] ::v-deep .kit-spinner {
...
button[selected]:not([appearance='danger']):not([appearance='warning']):not([appearance='help']) ::v-deep svg,
button[selected]:not([appearance='danger']):not([appearance='warning']):not([appearance='help']):hover ::v-deep svg,
button[selected]:not([appearance='danger']):not([appearance='warning']):not([appearance='help']):active ::v-deep svg {
  color: var(--kit-btn-selected-text);
}
...
button[loading][disabled] ::v-deep .kit-spinner {
  color: var(--kit-btn-disabled-text);
}
