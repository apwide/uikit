        ...
        <table ref="table">
            <thead
                ...
                <tr class="kit-table-header-row">
                    ...
                    <TableHeaderCell
                        v-for="column in columns" :key="column.id" :column="column"
            ...
            <tfoot v-show="infiniteScroll && !showLoadMore">
                <tr>
                    <td
                        ...
                        class="kit-infinite-scroll-loader">
                        <Spinner size="small"/>
                    </td>
                </tr>
            </tfoot>
  ...
  methods: {
    ...
    findDraggableParent(startNode: Element) {
      ...
      while (!dragged && this.$el.contains(candidate) && candidate.parentNode) {
        ...
        if (filteredSiblings && Array.from(filteredSiblings)
            .includes(candidate as Element)) {
          dragged = candidate;
        } else {
