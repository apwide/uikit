<template>
  <label :for="id" :disabled="disabled">
    <input :id="id" :disabled="disabled" type="checkbox" :checked="value" :appearance="appearance" @change="toggle" />
    <div class="slide" :size="size">
      <div class="slide-inner">
        <EditorDoneIcon v-if="value" data-cy="done" :size="iconSize" :primary-color="color" class="done" />
        <EditorCloseIcon v-else data-cy="cross" :size="iconSize" :primary-color="color" class="close" />
      </div>
    </div>
  </label>
</template>
